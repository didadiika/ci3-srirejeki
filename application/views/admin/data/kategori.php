...
$(document).ready(function(){
  var table = $('#tabel').DataTable({
     "language": {
        ...
        "order": [],
        "ajax": {
              url:"<?php echo base_url('data/kategori_tampil');?>",
              type:"GET",
        },
        "columnDefs": [ {
            "targets": 0,
...
$('#btn_hapus').on('click',function(){
    ...
    $.ajax({
    type : "POST",
    url  : "<?php echo base_url('data/kategori_hapus/')?>",
    data : {id: id},
            success: function(data){
...
<form action="<?php echo base_url('data/kategori_simpan') ;?>" method="post" id="form-tambah">
<div class="modal-body">

              <div id="tagNama" class="form-group">
                  <label class="control-label" for="inputError"><i id="iconNama"></i> Nama Kategori</label>
        ...
        <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url('data/kategori_update') ;?>" method="post" id="form-edit">
<div class="modal-body">
<input type="hidden" name="id_update">
              <div id="tagNama" class="form-group">
                  <label class="control-label" for="inputError"><i id="iconNama"></i> Nama Kategori</label>
                  <input type="text" name="nama_update" id="nama_update" class="form-control" placeholder="Nama Kategori" required>
                  <span class="help-block" id="pesanNama"></span>
              </div>
